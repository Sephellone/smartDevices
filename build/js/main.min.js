...
/* harmony import */ var _modules_liga_accordions_init_accordion__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/liga-accordions/init-accordion */ "./js/modules/liga-accordions/init-accordion.js");
/* harmony import */ var _modules_liga_accordions_about_accordion_button__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/liga-accordions/about-accordion-button */ "./js/modules/liga-accordions/about-accordion-button.js");
/* harmony import */ var _modules_modals_modal_focus__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/modals/modal-focus */ "./js/modules/modals/modal-focus.js");
/* harmony import */ var _utils_no_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/no-js */ "./js/utils/no-js.js");
/* harmony import */ var _modules_liga_accordions_accordion_focus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/liga-accordions/accordion-focus */ "./js/modules/liga-accordions/accordion-focus.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    Object(_utils_no_js__WEBPACK_IMPORTED_MODULE_6__["initJsElements"])();
    var form = new _modules_form_validate_form__WEBPACK_IMPORTED_MODULE_1__["Form"]();
    form.init();
    window.form = form;
    Object(_modules_modals_modal_focus__WEBPACK_IMPORTED_MODULE_5__["initModalFocus"])();
    Object(_modules_modals_init_modals__WEBPACK_IMPORTED_MODULE_2__["initModals"])();
    Object(_modules_liga_accordions_about_accordion_button__WEBPACK_IMPORTED_MODULE_4__["initAboutButton"])();
    Object(_modules_liga_accordions_init_accordion__WEBPACK_IMPORTED_MODULE_3__["initAccordions"])();
    Object(_modules_liga_accordions_accordion_focus__WEBPACK_IMPORTED_MODULE_7__["initAccordionTabindex"])();
  });
});
...
/***/ "./js/modules/liga-accordions/about-accordion-button.js":
/*!**************************************************************!*\
  !*** ./js/modules/liga-accordions/about-accordion-button.js ***!
  \**************************************************************/
/*! exports provided: initAboutButton */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAboutButton", function() { return initAboutButton; });
var aboutContainer = document.querySelector('[data-about-accordion]');
var accordionButtonClickHandler = function accordionButtonClickHandler(evt) {
  var accordionElement = aboutContainer.querySelector('[data-accordion="element"]');
  if (accordionElement) {
...
var initAboutButton = function initAboutButton() {
  if (typeof aboutContainer !== 'undefined' && aboutContainer !== null) {
    var accordionButton = aboutContainer.querySelector('[data-accordion="button"]');
    if (accordionButton) {
...
/***/ "./js/modules/liga-accordions/accordion-focus.js":
/*!*******************************************************!*\
  !*** ./js/modules/liga-accordions/accordion-focus.js ***!
  \*******************************************************/
/*! exports provided: initAccordionTabindex */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAccordionTabindex", function() { return initAccordionTabindex; });
var destroyableAccordeon = document.querySelectorAll('[data-accordion="parent"][data-destroy]');
var initAccordionTabindex = function initAccordionTabindex() {
  if (destroyableAccordeon && destroyableAccordeon.length) {
    destroyableAccordeon.forEach(function (accordeon) {
      var buttons = accordeon.querySelectorAll('[data-accordion="button"]');
...
/***/ "./js/modules/liga-accordions/accordions.js":
/*!**************************************************!*\
  !*** ./js/modules/liga-accordions/accordions.js ***!
  \**************************************************/
...
/***/ "./js/modules/liga-accordions/init-accordion.js":
/*!******************************************************!*\
  !*** ./js/modules/liga-accordions/init-accordion.js ***!
  \******************************************************/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "accordions", function() { return accordions; });
/* harmony import */ var _accordions__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./accordions */ "./js/modules/liga-accordions/accordions.js");
...
/***/ "./js/modules/modals/modal-focus.js":
/*!******************************************!*\
  !*** ./js/modules/modals/modal-focus.js ***!
  \******************************************/
/*! exports provided: initModalFocus */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initModalFocus", function() { return initModalFocus; });
...
var initModalFocus = function initModalFocus() {
  if (modal && firstField) {
    var modalMutationObserver = new MutationObserver(onClassChange);
...
/*!***************************!*\
  !*** ./js/utils/no-js.js ***!
  \***************************/
/*! exports provided: initJsElements */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initJsElements", function() { return initJsElements; });
var noJsBlocks = document.querySelectorAll('.no-js');
var initJsElements = function initJsElements() {
  if (noJsBlocks && noJsBlocks.length) {
    noJsBlocks.forEach(function (block) {
      return block.classList.remove('no-js');
    });
  }
};
